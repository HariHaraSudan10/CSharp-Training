...
//Create a Console application with a Class called Program which has TotalFare as Constant, Name, Age.  Accept Name, Age from the user and call the CalculateConcession() function to test the Classlibrary functiona
...
namespace Assignment7
{
    public class program
    {
        ...
        static void Main(string[] args)
        {
            ...
            TravelConcession.CalculateConcession(age, Fare);
